"""
resume_deploy_full_v3.py
─────────────────────────────────────────────────────────────────────────────
Versión v3 de resume_deploy_full.py alineada con main_oof.py, con
recalibración final sobre una cola temporal reciente y recomputación completa
de percentiles por estado sobre esa misma cola recalibrada.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "y añade recalibración final + recomputación de percentiles por estado sobre una cola reciente."
        )
    )
    parser.add_argument(
        "--side",
