...
def save_generated_policy_files(deploy_dir: Path, release: str, policy_bundle: dict):
    ...
    py_lines = [
        ...
        "Generated by resume_deploy_full_v4.py from deploy percentiles/calibration tail.",
...
if __name__ == "__main__":
    ...
    if args.validate_only:
        ...
        generate_policy_from_deploy_percentiles(deploy_dir, release)
